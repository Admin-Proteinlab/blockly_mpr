...
Blockly.Msg.error = "🛑 ERROR: bloques no estan conectados";
Blockly.Msg.verif = "⛔ Verifique primero"
Blockly.Msg.save = "Guardar como formato";
Blockly.Msg.update = "Actualizar";
Blockly.Msg.new_update = "Hay una nueva versión disponible, ¿desea descargarla e instalarla ahora mismo?" ;
Blockly.Msg.yes = "Si";
Blockly.Msg.no = "No";
...
Blockly.Msg.CAT_OTTO_QUAD = "🕷️ Cuadrupedo";
...
Blockly.Msg.CAT_SOUND ="🎤 Ruido"
Blockly.Msg.CAT_HMC5883="🧭 Brújula";
...
Blockly.Msg.CAT_RemoteIR = "🕹️ Control Remoto";
...
//sensor
Blockly.Msg.VL53L0X = "VL53L0X Ini. sensor de distancia láser. I2C";
...
Blockly.Msg.bme280 = "BME280 Ini. sensor de presión atmosférica. I2C";
...
Blockly.Msg.ultrason_distance1 = "distancia (cm)";
...
Blockly.Msg.ESP32Bluetooth = "Inicializa Bluetooth - ESP32 Bluetooth Serial";
Blockly.Msg.SSERIAL_BT_TX="Pin TX#";
Blockly.Msg.SSERIAL_BT_RX="Pin RX#";
Blockly.Msg.SSERIAL_BT_BAUD="Baudios";
Blockly.Msg.SSERIAL_BT_Read="Serial BT Leer byte";
Blockly.Msg.SSERIAL_BT_Println="Serial BT Imprimir en una nueva linea";
Blockly.Msg.SSERIAL_BT_Print="Serial BT Imprimir en la misma linea";
Blockly.Msg.SSERIAL_BT_Write="Serial BT escribir"
Blockly.Msg.SSERIAL_BT_Avai="Serial BT disponible?";
Blockly.Msg.SSerial_BT_Print_Format="Serial BT Imprimir en formato";
Blockly.Msg.SSERIAL_BT_ReadNum="Serial BT Leer como número";
...
Blockly.Msg.ARDUINO_RTTTL_BLOCK = "Tocar RTTTL modo blocking ";
...
Blockly.Msg.ARDUINO_SERVO_ROT_CONTINUE_TEXT = "Girar servo";
...
Blockly.Msg.ADAFRUIT_MOTORSHIELD_MOTOR_DIRECTION = "Direccion";
...
Blockly.Msg.OTTO9_MOVE_SPEED_CHOICE = [["Normal","2000"], ["Lento","3500"], ["Rápido","1500"]];
...
Blockly.Msg.OTTO9_DO_CHOICE = [["Meneito","swing"], ["Sube Baja","updown"], ["Puntillas y Meneo ","tiptoeSwing"], ["Inquieto","jitter"], ["Giro ascendente ","ascendingTurn"]];
Blockly.Msg.OTTO9_GESTURE_TEXT = "Gesto";
Blockly.Msg.OTTO9_GESTURE_TOOLTIP = "Sonidos emocionales combinados con movimientos";
Blockly.Msg.OTTO9_GESTURE_CHOICE = [["😃 Feliz", "OttoSuperHappy"], ["🙂 Alegre", "OttoHappy"], ["🙁 Triste", "OttoSad"], ["😴 Durmiendo", "OttoSleeping"], ["😕 Confundid@","OttoConfused"], [" 😰 Asustad@","OttoFretful"], ["😍 Enamorad@"," OttoLove "], ["😡 Enfadad@"," OttoAngry "], ["🤩 Magia"," OttoMagic "], ["😐 Ola"," OttoWave "], ["😎 Victoria"," OttoVictory "], ["😞 Fracaso"," OttoFail "], ["💩 Peo"," OttoFart "]];
Blockly.Msg.OTTO9_SOUND_TEXT = "Sonido";
Blockly.Msg.OTTO9_SOUND_TOOLTIP = "Sonidos emocionales";
Blockly.Msg.OTTO9_SOUND_CHOICE = [["😃 Feliz", "S_superHappy"], ["🙂 Alegre", "S_happy"], ["😊 Content@", "S_happy_short"], ["🙁 Triste", "S_sad"], ["😕 Confundid@","S_confused"], ["🤗 Cariños@"," S_cuddly "], ["😮 Oh"," S_OhOoh "], ["😯 Oohh"," S_OhOoh2 "], ["😲 Sorpresa"," S_surprise "], [" 🤖 Conexion "," S_connection "], [" 🤖 Desconexion "," S_disconnection "], [" 👇 Boton"," S_buttonPushed "], [" ❗ Modo"," S_mode1 "], [" ❗❗ Modo"," S_mode2 "], ["❗❗❗ Modo", "S_mode3"], ["💤 Dormir", "S_sleeping"], ["💩 Peo1", "S_fart1"], ["💩 Peo2", "S_fart2"], ["💩 Peo3", "S_fart3"],];
...
Blockly.Msg.OTTO9_GETTOUCH_TEXT = "Tacto";
...
//SIMPLE SENSORS
Blockly.Msg.BUTTON_NAME="Botón";
Blockly.Msg.BUTTON_LOGIC="Logica inversa";
Blockly.Msg.BUTTON_PRESSED="¿pulsado?";
Blockly.Msg.BUTTON_TOUCH_NAME="Sensor táctil";
Blockly.Msg.KNOCK_NAME="Golpe";
Blockly.Msg.KNOCK_DETECTED="¿detectado?";
Blockly.Msg.TILT_NAME="Inclinación";
Blockly.Msg.TILT_DETECTED="¿detectada?";
Blockly.Msg.POTE_NAME="Potenciometro";
Blockly.Msg.PERCENT="Porcentaje(0-100)%";
Blockly.Msg.VALUE="Valor(0-1023)";
Blockly.Msg.PHOTO_NAME="Fotointerruptor";
Blockly.Msg.PHOTO_DETECTED="¿detectado?";
Blockly.Msg.VAR_LM35="LM35 Temperatura (ºC)";
Blockly.Msg.LDR_NAME="Luz(LDR or CDS) ";
Blockly.Msg.LDR_DETECTED="¿detectado?";
Blockly.Msg.IR_NAME="Infrarrojo";
Blockly.Msg.IR_DETECTED="¿detectado?";
Blockly.Msg.FLAME_NAME="Llama";
Blockly.Msg.FLAME_DETECTED="¿detectada?";
Blockly.Msg.SOUND_NAME="Sonido (MIC)";
Blockly.Msg.SOUND_AMP_NAME="MIC amplificado";
Blockly.Msg.SOUND_WINDOWS="Ventana de muestreo";
Blockly.Msg.SOUND_DETECTED="¿detectado?";
...
Blockly.Msg.DHT_Humi="Humedad";
Blockly.Msg.DHT_Head="Indice de Calor ºC";
Blockly.Msg.GAS_NAME="Gas CO (MQ-7)";
Blockly.Msg.GAS_DETECTED="¿detectado?";
Blockly.Msg.ALCOHOL_NAME="Alcohol (MQ-3)";
Blockly.Msg.AIR_NAME="Air quality (MQ-135)";
Blockly.Msg.AIR_NAME="Calidad del aire(MQ-135)";
Blockly.Msg.ALCOHOL_DETECTED="¿detectado?";
Blockly.Msg.VIBRATION_NAME="Vibración";
Blockly.Msg.VIBRATION_DETECTED="¿detectada?";
Blockly.Msg.HALL_NAME="Hall Campo magnético";
Blockly.Msg.HALL_DETECTED="¿detectado?";
Blockly.Msg.PIR_NAME="PIR presencia";
Blockly.Msg.PIR_DETECTED="¿detectada?";
Blockly.Msg.VAPOR_NAME="Vapor (Steam)";
Blockly.Msg.ALIGHT_NAME="Luz de ambiente (TEMT6000)";
Blockly.Msg.WATER_NAME="Nivel de agua";
Blockly.Msg.MOISTURE_NAME="Humedad";
Blockly.Msg.JOYSTICK_NAME="Joystick eje";
Blockly.Msg.JOYSTICK_BUTTON="Joystick botón";
Blockly.Msg.JOYSTICK_PRESSED="¿pulsado?";
Blockly.Msg.ultrasonic_ranger="Ultrasonido Pines";
Blockly.Msg.unit="Unidad";
Blockly.Msg.cm="cm";
Blockly.Msg.inch="pulgada";
...
Blockly.Msg.ST7735_init = "Ini TFT ST7735 1.8\" or 0.96\".";
Blockly.Msg.ST7735_init2 = "Pines: SCL=SCK SDA=MOSI.";
...
//TM1640
Blockly.Msg.TM1640_init = "Ini TM1640 Matriz de leds";
...
Blockly.Msg.WIFI_sta_init = "WIFI.Conectar como estación";
Blockly.Msg.WIFI_ap_init = "WIFI.Crear un punto de acceso";
Blockly.Msg.WIFI_sta_ap_init = "WIFI. Estación y Punto de Acceso";
...
Blockly.Msg.Telegram_Loop = "Telegram Loop.Actualizar mensajes";
Blockly.Msg.Telegram_receive = "Telegram.Cuando un mensaje es recibido";
Blockly.Msg.TelegramSend= "Enviar mensaje::";
Blockly.Msg.Telegram_message = "Telegram.Mensaje recibido";
Blockly.Msg.Telegram_fromName= "Nombre de la persona que envío el mensaje";

//OpenWeather
Blockly.Msg.Openweather_init = "Configuración OpenWeather.";
Blockly.Msg.Api_key = "Api Key";
Blockly.Msg.ReadWeather = "OpenWeather.Obtener el tiempo";
Blockly.Msg.City = "Ciudad";
Blockly.Msg.CountryCode = "Código de país";
Blockly.Msg.OW_Value = "OpenWeather. Valor:";
Blockly.Msg.LocationOW = "Ciudad";
Blockly.Msg.Country = "País";
Blockly.Msg.Icon = "Icono";
Blockly.Msg.Weather = "Tiempo";
Blockly.Msg.Description = "Descripción";
Blockly.Msg.OW_Temperature = "Temperatura ºC";
Blockly.Msg.Temp_max = "Temperatura Max ºC";
Blockly.Msg.Temp_min = "Temperatura Min ºC";
Blockly.Msg.Humidity = "Humedad";
Blockly.Msg.Preassure = "Presión";
Blockly.Msg.Feels_like = "Sensación Térmica ºC";
Blockly.Msg.Cloud = "% nubes";
Blockly.Msg.Visibility = "% Visibilidad";
Blockly.Msg.wind_speed = "Velocidad del viento";
Blockly.Msg.wind_angle = "Ángulo del viento";
Blockly.Msg.icon_id = "Icono del tiempo Id";
